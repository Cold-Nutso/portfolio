...
<div class='project'>
    <section class='banner'>
        <img class='icon1' src='media/sms-logo.png' alt=''>
        <div>
            <h3 class='name'>Title</h3>
            <p class='subtitle'><em>Subtitle</em></p>
        </div>
        <img class='icon2' src='media/sms-logo.png' alt=''>
    </section>
    <div class='dropdown'>
        <div class='info'>
        </div>
...
class PersonalProject extends HTMLElement {
    ...
    static get observedAttributes() {
        return [ "data-index", "data-id", "data-name", "data-subtitle", "data-icon1", "data-icon2", "data-info" ];
    }
    ...
    render() {
        ...
        this.name.innerHTML = this.getAttribute("data-name") ? this.getAttribute("data-name") : "Name";
        this.subtitle.innerHTML = this.getAttribute("data-subtitle") ? this.getAttribute("data-subtitle") : "Subtitle";
        this.icon1.src = this.getAttribute("data-icon1") ? this.getAttribute("data-icon1") : "media/sms-logo.png";
        this.icon2.src = this.getAttribute("data-icon2") ? this.getAttribute("data-icon2") : this.icon1.src;
        this.info.innerHTML = this.getAttribute("data-info") ? this.getAttribute("data-info") : "I think something went wrong.";
    }
