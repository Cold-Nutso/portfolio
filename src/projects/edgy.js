...
class NounPair {
  ...
  constructor(singular, plural = 'default') {
    ...
    Object.defineProperties(this, {
      full: {
        get() {
          if (hasPlural) return `${this._singular} / ${this._plural}`;
          else return this._singular;
        },
      },
    });
  }
  ...
  constructor(firstWord, secondWord, style) {
    ...
    Object.defineProperties(this, {
      firstWord: {
        get() {
          if (this.style == 'AdjNoun') {
            return this._tempAdj;
          } else {
            return this._tempNounA;
          }
        },
        set(val) {
          if (this.style == 'AdjNoun') {
      ...
      full: {
        get() {
          if (this.style == 'AdjNoun') {
            return `${this.tempAdj} ${this.tempNounB.singular}`;
          } else if (this.style == 'NounNoun') {
            return `${this.tempNounA.singular} ${this.tempNounB.singular}`;
          } else if (this.style == 'PosNoun') {
            return `${this.tempNounA.singular}'s ${this.tempNounB.singular}`;
          }
        },
      },
    });
...
class EdgyTitle {
      ...
      full: {
        get() {
          switch (this.style) {
            ...
            case 'ThePosNoun':
              if (this.tempNounA.hasPlural) {
                return `The ${this.tempNounA.singular}'s ${this.tempNounB.singular}`;
              } else {
                return `${this.tempNounA.singular}'s ${this.tempNounB.singular}`;
              }

            case 'NounOfTheNoun':
              if (this.tempNounB.hasPlural) {
                return `${this.tempNounA.singular} of the ${this.tempNounB.singular}`;
              } else {
                return `${this.tempNounA.singular} of ${this.tempNounB.singular}`;
              }

            case 'TheNounOfTheNoun':
              if (this.tempNounB.hasPlural) {
                return `The ${this.tempNounA.singular} of the ${this.tempNounB.singular}`;
              } else {
                return `The ${this.tempNounA.singular} of ${this.tempNounB.singular}`;
              }

            case 'NounOfPlur':
              if (this.tempNounB.hasPlural) {
                return `${this.tempNounA.singular} of ${this.tempNounB.plural}`;
              } else {
                return `${this.tempNounA.singular} of ${this.tempNounB.singular}`;
              }
            ...
            case 'NounOfThePlur':
              if (this.tempNounB.hasPlural) {
                return `${this.tempNounA.singular} of the ${this.tempNounB.plural}`;
              } else {
                return `${this.tempNounA.singular} of the ${this.tempNounB.singular}`;
              }
            ...
            case 'TheNounOfPlur':
              if (this.tempNounB.hasPlural) {
                return `The ${this.tempNounA.singular} of ${this.tempNounB.plural}`;
              } else {
                return `The ${this.tempNounA.singular} of ${this.tempNounB.singular}`;
              }
  ...
  cycleStyle() {
    ...
    } else if (this.style == 'TheNounNoun') {
      this.style = 'ThePosNoun';
    } else if (this.style == 'ThePosNoun') {
      this.style = 'NounOfTheNoun';
    } else if (this.style == 'NounOfTheNoun') {
      this.style = 'TheNounOfTheNoun';
    } else if (this.style == 'TheNounOfTheNoun') {
      this.style = 'NounOfPlur';
    } else if (this.style == 'NounOfPlur') {
      this.style = 'NounOfThePlur';
    } else if (this.style == 'NounOfThePlur') {
      this.style = 'TheNounOfPlur';
    } else if (this.style == 'TheNounOfPlur') {
      this.style = 'TheNounNoun';
    }
  }
...
let edgyName = new EdgyName(
  new NounPair('Shadow', 'Shadows'),
  new NounPair('Demise'),
  'PosNoun'
);
let edgyTitle = new EdgyTitle(
  new NounPair('Prince', 'Princes'),
  new NounPair('Darkness'),
  'NounOfTheNoun'
);
...
edgyRoot.querySelector('#edgy-name-a-random-btn').onclick = () => {
  ...
  else edgyName.firstWord = randElem(randElem(nounFams).items);
...
edgyRoot.querySelector('#edgy-title-a-random-btn').onclick = () => {
  ...
  else edgyTitle.firstWord = randElem(randElem(nounFams).items);
...
edgyRoot.querySelector('#edgy-title-b-random-btn').onclick = () => {
  ...
  else edgyTitle.secondWord = randElem(randElem(nounFams).items);
...
function loadAdjs() {
  const url = './assets/proj/edgy/edgy-adjs.csv';
  ...
  xhr.onload = (e) => {
    ...
    for (let line of lines) {
      ...
      for (let i = 2; i < line.length; i++) newFam.items.push(line[i]);
...
function loadNouns() {
  const url = './assets/proj/edgy/edgy-nouns.csv';
  const xhr = new XMLHttpRequest();
  xhr.onload = (e) => {
    const text = e.target.responseText;
...
function updateButtons() {
  ...
  else edgyRoot.querySelector('#edgy-title-swap-btn').disabled = false;
}
...
function genEdgyName() {
  ...
  switch (roll) {
    ...
    case 2:
      ...
      if (roll == 1) return new EdgyName(tempNounA, tempNounB, 'PosNoun');
      else return new EdgyName(tempNounA, tempNounB, 'NounNoun');
  }
}
...
function genEdgyTitle() {
  ...
  switch (roll) {
    ...
    case 4:
      ...
      else return new EdgyTitle(tempNounA, tempNounB, 'TheNounOfPlur');
